        ...
        FirebaseDatabase.getInstance().getReference().child("Mua Cầu Thủ").push()
                .setValue(map).addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        Toast.makeText(Add_MainActivity.this,"Thêm cây xanh thành công!",Toast.LENGTH_SHORT).show();

                    }
                }).addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(Add_MainActivity.this,"Thêm cây xanh thất bại!",Toast.LENGTH_SHORT).show();
